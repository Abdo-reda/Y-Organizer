  ...
  <FunctionCard title="Now v2">
    ...
    <div class="grid grid-cols-3 gap-4 mb-4">
      ...
      <div class="col-span-2 space-y-3">
        <h3 class="text-sm font-semibold text-gray-700 mb-3">Upcoming Tasks</h3>
        ...
        <!-- Add Task Button -->
        <button
          class="w-full p-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-blue-400 hover:text-blue-600 transition-all flex items-center justify-center gap-2"
        >
      ...
      <div class="space-y-3">
        ...
        <div class="relative">
          <textarea
            ...
            class="w-full h-32 p-3 text-sm border border-gray-200 rounded-lg resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
    ...
    <div class="border-t border-gray-200 pt-4">
      <button
        ...
        class="flex items-center justify-between w-full text-left mb-3 hover:bg-gray-50 p-2 rounded-lg transition-colors"
      >
      ...
      <div v-if="showCompleted" class="space-y-2 max-h-32 overflow-y-auto">
        <div
