...
import { CheckCheckIcon, CheckIcon, FocusIcon, ListCheckIcon, NotepadTextIcon, PlusIcon, ZapIcon } from "lucide-vue-next";
						...
						<li v-for="task in focusedTasks" :key="task.id" class="h-1/3 pb-3">
							...
							>
								...
								<div class="flex-1 min-w-0">
									<div class="font-medium text-sm text-foreground/75 truncate">{{ task.title }}</div>
